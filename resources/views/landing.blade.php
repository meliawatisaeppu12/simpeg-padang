...
<head>
    ...
    <title>SIMPEG Kabupaten Kepulauan Mentawai</title>
    ...
    <style>
        ...
        body {
            ...
            background-color: #D0F0FF; /* Biru pastel lembut untuk bagian luar */
        }

        .landing-card {
            background-color: #ffffff; /* Putih untuk container utama */
        }

        footer {
            background-color: #D0F0FF; /* Footer serasi dengan luar */
        }
    </style>
</head>
    ...
    <div>
        ...
        <main class="mt-5">
            <section class="bg-landing header relative items-start flex my-32 md:py-16 md:my-0 base64"
                ...
                <div class="container mx-auto landing-card rounded-lg shadow-lg px-8 py-12 flex flex-col md:flex-row items-center ">
                    <div class="items-center flex flex-col md:flex-row-reverse">
                        <div class="w-full md:w-5/12 px-4 mr-auto ml-auto my-16 md:my-0">
                            <img alt="..." class="max-w-full rounded-lg" src="{{ url('/img/asnmtw.png') }}" />
                        </div>
                        <div class="w-10/12 md:w-6/12 px-4 mr-auto ml-auto">
                            <div class="">
                                ...
                                <p style="font-family: Roboto; font-weight: 300"
                                    ...
                                    SIMPEG Kabupaten Kepulauan Mentawai Merupakan Sistem Pengelolaan Data Pegawai di Lingkungan
