...
<head>
    ...
    <!-- Site favicon -->
    <link rel="icon" type="image/png" href="{{ url('img/mentawai.png') }}">
    ...
    @if (app('router')->getRoutes()->match(Request::create($previousUrl))->getName() == 'login')
        <div class="pre-loader">
            <div class="pre-loader-box">
                <div class="loader-logo"><img src="{{ url('vendor/images/mentawai.gif') }}" alt=""></div>
        ...
        <div class="header-left ml-4">
            <div class="brand-logo mr-5">
                <a href="{{ route('dashboard') }}">
                    <img src="{{ url('vendor/images/simpegmtw.png') }}" alt="" class="dark-logo">
                    <img src="{{ url('vendor/images/simpegmtw.png') }}" alt="" class="light-logo">
                </a>
            </div>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <div class="footer-wrap pd-20 card-box position-fixed fixed-bottom">
                        <div>Sistem Informasi Kepegawaian Pemerintah Kabupaten Kepulauan Mentawai</div>
                    </div>
                </div>
            </div>
        </div>
