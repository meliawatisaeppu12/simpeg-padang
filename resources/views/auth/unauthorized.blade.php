...
<head>
    ...
    <title>SIMPEG | Unauthorized</title>
    <style>
...
<body id="unauthorized">
    <div class="container">
        ...
        <p>Halo {{ $nama }}, <br>sepertinya kamu tidak memiliki izin untuk mengakses aplikasi ini
            <br>atau mungkin izin pada akunmu belum diatur.
            <br>
