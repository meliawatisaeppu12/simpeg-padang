<x-admin>
    <div class=<div class="py-12" style="background: linear-gradient(135deg, #4facfe, #a0e052ff);">
                ...
                <div class="pd-ltr-20">
                    <div class="card-box pd-20 height-100-p mb-30">
                        <div class="row align-items-center">
                            <div class="col-md-4">
                                <img src="{{url('vendor/images/aparatur.png')}}" alt="">
                            </div>
                            <div class="col-md-8">
                                ...
                                <p class="font-18 max-width-600">Kelola data kepegawaian menggunakan Sistem Informasi Kepegawaian (SIMPEG) Kab. Kepulauan Mentawai.</p>
                            </div>
                        </div>
                    </div>
                    @if($hak_akses)
