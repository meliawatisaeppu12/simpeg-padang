function CopyToClipboard(e,t,o){var n=$("<input>");if(""!=e){n=$("<input>");$("body").append(n),n.val(e).select(),document.execCommand("copy"),n.remove()}
void 0===t&&(t=!0),void 0===o&&(o="Copied to clipboard");var a=$("div.copy-notification");t&&0==a.length&&((a=$("<div/>",{class:"copy-notification",text:o})),$("body").append(a),a.fadeIn("slow",function(){setTimeout(function(){a.fadeOut("slow",function(){a.remove()})},1e3)}))}
jQuery(window).on("load",function(){"use strict";$(".textarea_editor").wysihtml5({html:!0})}),jQuery(document).ready(function(){"use strict";jQuery(".bg_img").each(function(e,t){var o=jQuery(t);jQuery(this).hide(),jQuery(this).parent().css({background:"url("+o.attr("src")+") no-repeat center center"})}),jQuery("img.svg").each(function(){var o=jQuery(this),n=o.attr("id"),a=o.attr("class"),e=o.attr("src");jQuery.get(e,function(e){var t=jQuery(e).find("svg");void 0!==n&&(t=t.attr("id",n)),void 0!==a&&(t=t.attr("class",a+" replaced-svg")),!(t=t.removeAttr("xmlns:a")).attr("viewBox")&&t.attr("height")&&t.attr("width")&&t.attr("viewBox","0 0 "+t.attr("height")+" "+t.attr("width")),o.replaceWith(t)},"xml")});var i={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;","/":"&#x2F;"};(window.onload=function(){var e=document.querySelectorAll("pre code");if(e.length){for(var t=0,o=e.length;t<o;t++){var n=e[t],a=n.innerHTML;(a=String(a).replace(/[&<>"'\/]/g,function(e){return i[e]})),(n.innerHTML=a)}
...
if(0<e.indexOf("Trident/")){var o=e.indexOf("rv:");parseInt(e.substring(o+3,e.indexOf(".",o)),10);document.querySelector("body").className+=" IE"}})()